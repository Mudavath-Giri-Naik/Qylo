"use client"
/* eslint-disable react-hooks/immutability -- standard ref-forwarding (writing
   externalRef.current inside a ref callback); this rule's static analysis
   flags the idiom itself, not an actual render-time mutation. */
...
import { getMotionSettings, getMorphProfile, subscribeMotion, type Category } from "@/lib/cojeev-motion/settings"
