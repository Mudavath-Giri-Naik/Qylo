...
export default function ComposerFooter() {
  return (
    <footer className="flex shrink-0 flex-wrap items-center justify-between gap-3 border-t border-[var(--border)] bg-[var(--composer-bar)] px-4 py-2.5 text-xs text-[var(--foreground-subtle)]">
